...
> **면책조항**: 이 앱은 "Two Rooms and a Boom" 보드게임을 위한 비공식 도구입니다. 이 앱은 원작 게임과 관련이 없으며, 개인적인 학습 및 게임 진행 편의를 위해 제작되었습니다. 모든 권리는 원작자에게 있습니다.
...
이 앱은 "Two Rooms and a Boom" 파티 게임을 위한 비공식 도구입니다.
- 원작 게임: "Two Rooms and a Boom"
- 이 앱은 원작자와 관련이 없는 독립적인 프로젝트입니다
- 상업적 목적이 아닌 개인 학습 및 게임 진행 편의를 위해 제작되었습니다

**중요**: 실제 게임을 플레이하려면 공식 게임을 구매해주세요.
